...
For animation and short, these genres show the highest density at the shortest runtimes, which aligns with expectations since animated and short films are typically brief.
  * How many titles are known for name that is different than the original release name?
  There are 6458 titles with different names
...
For all actors' first names are "Tom", "Thomas", "Thom" or "Tomas", there are 1646 actors.
* How many titles use alliteration (i.e., all words in the title start with the same letter)?
Number of alliteration titles are: 2101.
